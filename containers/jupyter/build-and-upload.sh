...
# Run from repo root: ./containers/jupyter/build-and-upload.sh
...
echo "- Docker images: Built for AMD64 architecture (works on all platforms)"
echo "- Docker images: Optionally pushed to GHCR"
echo ""
echo "🔧 Next steps:"
echo "- Test the uploaded package: pip install altastata"
echo "- Test Docker images (from repo root): docker compose -f containers/jupyter/docker-compose.yml up -d"
