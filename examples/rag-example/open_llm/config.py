...
# Set RAG_TIMING_LOG=1 to print per-query phase timings (embed+search, AltaStata chunk reads, LLM)
RAG_TIMING_LOG = os.getenv("RAG_TIMING_LOG", "").strip().lower() in ("1", "true", "yes")
