...
echo ""
echo "🔧 Storage setup will be automatically configured when you access the notebook"
echo "📝 Use the storage_manager object in your notebooks to access GCS and BigQuery"
